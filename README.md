...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eefolium-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11367&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eefolium-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eefolium` can be installed with:

```
conda install eefolium
```

It is possible to list all of the versions of `eefolium` available on your platform with:
